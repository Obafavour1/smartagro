    ...
    <section id='projects' className='py-10'>
        <div className='maxcontainer'>
            ...
            <div className='max-md:flex-col items-center flex gap-x-3 justify-between'>
                <img src={project1} alt=""className='w-[320px] md:w-[250px]' />
                ...
                <img src={project3} alt=""className='w-[320px] md:w-[250px]' />
                <img src={project4} alt=""className='w-[320px] md:w-[250px] mt-3' />
            </div>
        </div>
    </section>
  )
